/****************************************************************************
** Meta object code from reading C++ file 'dbmanger.h'
**
...
#error "The header file 'dbmanger.h' doesn't include <QObject>."
...
const QMetaObject DBManager::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DBManager.data,
